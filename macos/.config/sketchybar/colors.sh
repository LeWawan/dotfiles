...
export INDIGO=0xFFa0a1fe #a0a1fe
export PURPLE=0xFFc7a9f7 #c7a9f7
export MAGENTA=0xFFf29df4 #f29df4
export RASPBERRY=0xFFf29df4 #f29df4

export WHITE=0xFFcdd6f4 #cdd6f4
export BLACK=0xFF2d2d2d #2d2d2d
export DARK_WHITE=0xFF9399b2  #9399b2

export BG_PRI_COLR=0xEE1e1e2e #1e1e2e
export BG_SEC_COLR=0xFF313244 #313244

export ACCENT_COLR=$INDIGO
